    ...
    <div style={{ minHeight: '100vh', background: '#F5F0EB', display: 'flex' }}>
      ...
      <div style={{ width: '240px', background: '#631621', color: '#FAF7F2', display: 'flex', flexDirection: 'column', flexShrink: 0, minHeight: '100vh' }}>
        ...
        <div style={{ padding: '24px' }}>
          <Link href="/" style={{ display: 'block', textAlign: 'center', padding: '10px', border: '1px solid rgba(255,255,255,0.2)', color: '#FAF7F2', textDecoration: 'none', fontSize: '10px', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '10px' }}>
            Continue Shopping
          </Link>
          ...
          <div>
            ...
            <div style={{ background: '#FAF7F2', padding: '32px', maxWidth: '500px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <button style={{
                  padding: '14px', background: '#631621', color: '#FAF7F2',
